...
export const MOCK_CATEGORIES: CategoryRow[] = [
  ...
  category(
    ...
    "Llaveros creativos",
    "llaveros",
    "Llaveros listos para personalizar y darle identidad a tus piezas.",
    10,
  ),
  category(
  ...
  category(
    ...
    "Acrylab",
    "acrilicos",
    "Bases, blanks y piezas de acrílico listas para personalizar.",
    12,
  ),
  category(
    ...
    "Accesorios, repuestos y consumibles para mantener tu producción creativa lista.",
    13,
  ),
  category(
    ...
    "Brillos, colores y decoraciones para darle textura y personalidad a tus piezas.",
    14,
  ),
  category(
    ...
    "Magic Flow",
    "magic-flow",
    "Líquidos y mezclas para lograr movimiento, caída lenta y efectos visuales dentro de tus vasos.",
    15,
  ),
  category(

...
insert into public.categories (id, title, handle, description, sort_order, status) values
  ...
  ('c0000000-0000-4000-8000-00000000000a', 'Llaveros creativos', 'llaveros',
   'Llaveros listos para personalizar y darle identidad a tus piezas.', 10, 'activa'),
  ...
  ('c0000000-0000-4000-8000-00000000000c', 'Acrylab', 'acrilicos',
   'Bases, blanks y piezas de acrílico listas para personalizar.', 12, 'activa'),
  ('c0000000-0000-4000-8000-00000000000d', 'Creator Tools', 'accesorios-personalizacion',
   'Accesorios, repuestos y consumibles para mantener tu producción creativa lista.', 13, 'activa'),
  ('c0000000-0000-4000-8000-00000000000e', 'Sparkle Mix', 'repuestos-consumibles',
   'Brillos, colores y decoraciones para darle textura y personalidad a tus piezas.', 14, 'activa'),
  ('c0000000-0000-4000-8000-00000000000f', 'Magic Flow', 'magic-flow',
   'Líquidos y mezclas para lograr movimiento, caída lenta y efectos visuales dentro de tus vasos.', 15, 'activa'),
